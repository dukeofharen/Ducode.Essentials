...
namespace Ducode.Essentials.Mvc
{
   ...
   public class ClientIpResolver : IClientIpResolver
   {
      ...
      public string GetClientIp()
      {
         ...
         string actualIp = NormalizeIp(_httpContextAccessor.HttpContext.Connection.RemoteIpAddress.ToString());
         ...
         if (forwardedHeader.Key != null && actualIp == "127.0.0.1")
         {
            ...
            string forwardedIp = NormalizeIp(parts.First());
            return forwardedIp;
         }
      ...
      private string NormalizeIp(string ip) => ip == "::1" ? "127.0.0.1" : ip;
   }
}
